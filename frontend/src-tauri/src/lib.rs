...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::api_get_translation_settings,
            api::api_save_translation_settings,
            audio::transcription::translation::set_translation_enabled,
            audio::transcription::translation::set_translation_target,
